...
public class TataProducts implements Comparable<TataProducts> {
	...
	public static void main(String[] args) {
		TataProducts t1 = new TataProducts(101, "Tcs", 13.87);
		TataProducts t2 = new TataProducts(109, "Tata water", 19.64);
		TataProducts t3 = new TataProducts(103, "Tanishque", 43.17);
		TataProducts t4 = new TataProducts(100, "Titan", 10.54);
		TataProducts t5 = new TataProducts(106, "Tata salt", 28.93);
